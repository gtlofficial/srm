...
export default function About2() {
  return (
    ...
    >
      <div className="section-outer panel py-6 xl:py-6 bg-secondary dark:bg-gray-800">

        <div className="container max-w-lg">
          <div className="section-inner panel">
            <div
              className="panel vstack text-start sm:text-center md:text-center"
              data-anime="onview: -100; targets: >*; translateY: [48, 0]; opacity: [0, 1]; easing: spring(1, 80, 10, 0); duration: 450; delay: anime.stagger(100, {start: 200});"
            >
              <h2 className="h3 lg:h2 mb-3">Our Promise</h2>
              ...
              <h2 className="h3 lg:h2 my-3">Our Facilities</h2>
              <p className="fs-5 xl:fs-4 text-dark dark:text-white text-opacity-70">
              ...
              <h2 className="h3 lg:h2 my-3">Why Choose SRM</h2>
              <p className="fs-5 xl:fs-4 text-dark dark:text-white text-opacity-70 m-auto text-start">✅ Over 25 years of professional experience<br></br>
              ...
              <h2 className="h3 lg:h2 my-3">Our mission</h2>
